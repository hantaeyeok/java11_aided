...
//shape로 출발해서 color라는 Composite를 넣음으로써 여러가지 수를 만들 수 있다. 
//Bridge (Color)를 특정 추상화 클래스(Shape)에 맴버로 기용하고, 서브 클래스(Triangle, Pentagon) 에서
//해당 색상을 골라 서로 다른 클래스를 조합하여 워래 보다 더 큰 객체를 구현할 수 있도록 하는 패턴
